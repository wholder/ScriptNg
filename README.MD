...
ScriptNg is an experimental interpreter for a simple scripting language I'm developing.  The included ScriptRunner class (shown above) provides an easy way to try out the ScriptNg interpreter by running the sample script, or writing your own.  ScriptRunner provides the following features:
